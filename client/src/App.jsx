...
const API_BASE_URL = import.meta.env.VITE_API_URL || (window.location.origin.includes('localhost') ? 'http://localhost:5000/api' : '/api');
        ...
        <div className="wrap nav-inner">
          ...
          <div className="nav-links">
            <a
              ...
              onClick={() => { setView('admin'); fetchRegistrations(); }}
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M12 2a5 5 0 1 1 0 10A5 5 0 0 1 12 2z" strokeLinecap="round"/>
